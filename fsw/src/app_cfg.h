...
#define CFG_ASTRO_PI_SCRIPT_TLM_TOPICID     ASTRO_PI_SCRIPT_TLM_TOPICID
...
#define APP_CONFIG(XX) \
   ...
   XX(ASTRO_PI_SCRIPT_TLM_TOPICID,uint32) \
...
#define ASTRO_PY_BASE_EID      (APP_C_FW_APP_BASE_EID + 20)
